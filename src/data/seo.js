const SEO = [
	{
		...
		keywords: ["Clément Gros"],
	},

	{
		page: "about",
		description:
			"Journaliste indépendant spécialisé dans les sujets politiques et économiques. J'ai une formation solide en journalisme et une expertise dans l'analyse des politiques publiques.",
		keywords: ["Clément Gros"],
	},

	{
		page: "articles",
		description:
			"Curiculum vitae de Clément Gros, journaliste indépendant spécialisé dans les sujets politiques et économiques. Découvrez son parcours professionnel, ses compétences et ses expériences dans le domaine du journalisme.",
		keywords: ["Clément Gros"],
	},
